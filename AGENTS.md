# cpp-live-text-to-speech

C++ (Crow) demo app for Deepgram Live Text-to-Speech.
...
```
feat(cpp-live-text-to-speech): add diarization support
fix(cpp-live-text-to-speech): resolve WebSocket close handling
refactor(cpp-live-text-to-speech): simplify session endpoint
