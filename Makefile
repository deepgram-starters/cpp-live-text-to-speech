# C++ Live Text-to-Speech Makefile
...
help:
	@echo "C++ Live Text-to-Speech - Available Commands"
	@echo "============================================="
	@echo ""
	@echo "Setup:"
...
# Install backend dependencies (build C++ project)
install:
...
start-backend:
	...
	@if [ ! -f "build/cpp-live-text-to-speech" ]; then \
		echo "Error: Backend binary not found. Run 'make install' first."; \
		exit 1; \
	fi
	@echo "==> Starting backend on http://localhost:8081"
	./build/cpp-live-text-to-speech
